...
public class app {
    ...
    public static void inputData() throws IOException {
        System.out.println ("Введите Фамилия Имя Отчество дата_рождения (dd.mm.yyyy) номер_телефона пол");
        ...
        File file = new File(String.format("c://Test//User.txt", familyName[0]));
